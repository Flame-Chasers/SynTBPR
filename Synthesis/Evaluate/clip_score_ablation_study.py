...
json_path = '/mnt/lustre/zengziyin/lyx/Data/Unsupervised/Image_to_text/Result/Compose/location-2w-new-2w-profession-2w-sport-2w-random-2w_train_reid.json'
...
if len(batch_images) > 0:
    ...
    scores.append(scores_batch)
if len(scores) > 0:
    print("{} is {}".format(json_path,sum(scores) / len(scores)))
